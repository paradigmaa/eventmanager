...
public class UserExceptionHandler {
    ...
    public ResponseEntity<ServerError> handlerNotFoundUserException(UserNotFoundException e) {
    ...
    public ResponseEntity<ServerError> handlerLoginTakenNameUserException(LoginTakenNameException e) {
        log.warn("Ошибка, такой логин уже есть: {}", e.getMessage());
